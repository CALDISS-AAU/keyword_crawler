...
starturl_filename = "drr_new-links_20210505.txt"
...
keywords_exclude = ['social media', 'government', 'participatory', 'youtube', 'nongovernmental organizations', 'notifications']    
keywords = kw_raw.lower().split("\n\n")
keywords = keywords[1:len(keywords)]
keywords = [keyword.strip() for keyword in keywords if keyword not in keywords_exclude]
